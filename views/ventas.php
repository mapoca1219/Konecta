		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td><a class="btn btn-danger" href="<?php echo "../Controllers/eliminarVenta.php?id=" . $venta->id?>"><i class="fa fa-trash"></i></a></td>
				</tr>
				<?php } ?>
			</tbody>
		</table>
