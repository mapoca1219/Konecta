...
$sentenciaProductos = $base_de_datos->prepare("SELECT p.codigo, p.referencia, p.precio, pv.cantidad
FROM productos p
INNER JOIN 
...
<body>
    <div class="ticket">
        <img src="./logo-icon.jpg" alt="Logotipo" width="90" height="90">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="producto"><?php echo $producto->referencia;  ?> <strong>$<?php echo number_format($producto->precio, 2) ?></strong></td>
